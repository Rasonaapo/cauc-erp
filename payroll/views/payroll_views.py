...
from ..forms import SalaryItemForm, LoanForm, CreditUnionForm, PayrollForm
...
def setup_tax(request):
    ...
    return render(request, 'payroll/setup_tax.html', context)

# Salary Items
class SalaryItemListView(LoginRequiredMixin, ListView):
    model = SalaryItem
    template_name = 'payroll/salaryitem_list.html'
...
class SalaryItemCreateView(LoginRequiredMixin, CreateView):
    model = SalaryItem
    template_name = "payroll/salaryitem_form.html"
...
class SalaryItemEmployeeDetailView(LoginRequiredMixin, DetailView):
    model = SalaryItem
    template_name = 'payroll/salaryitem_employee_detail.html'
    context_object_name = 'salary_item'
...
class SalaryItemVariableDetailView(LoginRequiredMixin, DetailView):
    model = SalaryItem
    template_name = 'payroll/salaryitem_variable_detail.html'
    context_object_name = 'salary_item'
...
class CreditUnionListView(LoginRequiredMixin, ListView):
    model = CreditUnion
    template_name = 'payroll/creditunion_list.html'
...
class CreditUnionCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'payroll/creditunion_form.html'
...
class CreditUnionSetEmployeeDetailView(LoginRequiredMixin, DetailView):
    model = CreditUnion
    template_name = "payroll/creditunion_set_detail.html"
    context_object_name = "credit_union"
...
class BankListView(LoginRequiredMixin, ListView):
    model = Bank 
    template_name = 'payroll/bank_list.html'
...
class BankCreateView(LoginRequiredMixin, CreateView):
    model = Bank
    template_name = 'payroll/bank_form.html'
    fields = ['bank_name']
...
class PayrollVoucherDetailView(LoginRequiredMixin, DetailView):
    model = Payroll
    template_name = 'payroll/payroll_voucher.html'
    context_object_name = 'payroll'
