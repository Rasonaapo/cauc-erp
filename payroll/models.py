...
class SalaryGrade(models.Model):
    ...
    step = models.ForeignKey('SalaryStep', null=True, on_delete=models.CASCADE, related_name='salary_grades', verbose_name='Step')
...
class Tax(models.Model):
    ...
    block = models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=2, verbose_name='Block') #models.FloatField(null=True, blank=True)  
    rate = models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=2, verbose_name='Rate') #models.FloatField(null=True, blank=True)
    active = models.BooleanField(default=True)  
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)  
...
class Payroll(models.Model):
    ...
    salary_grade = models.ManyToManyField('SalaryGrade', blank=True, related_name="payrolls", verbose_name="Salary Grades")
